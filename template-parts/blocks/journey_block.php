...
?>
    ...
    <section id="journey" class="lqd-section module-sec journey--block bg-orange-100 min-h-100vh pt-5 pb-md-10 pb-8  d-flex align-items-center justify-content-center  overflow-hidden">
        <div class="">
            <div class="row">
