...
var Animation = /*#__PURE__*/_createClass(function Animation() {
  ...
  _defineProperty(this, "title_animation", function () {
    ...
    function title_animation() {
      ...
      quotes.forEach(function (quote) {
        ...
        quote.split = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"](quote, {
    ...
    title_animation();
    var typeSplit = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"]("[text-split]", {
      types: "words, chars",
      tagName: "span"
    });
  ...
  _defineProperty(this, "textRevealAnimation", function () {
    ...
    splitTypes.forEach(function (_char, i) {
      var text = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"](_char, {
        types: ['chars', 'words']
      });
  ...
  _defineProperty(this, "textGradientAnimation", function () {
    if (innerWidth > 576) {
      ...
      var mySplitText = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"](".folks-text", {
        type: "words,chars,capitalize"
      });
      var chars = mySplitText.chars;

      // Define the start and end colors for the gradient
      var startColor = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"])("#14CF93");
      var endColor = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"])("#F8EC3A");
      folksBD.to(chars, {
        duration: 0.5,
        scaleY: 0.6,
        ease: "power3.out",
      ...
      folksBD.to(chars, {
        color: function color(i, el, arr) {
          ...
          return tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"].mix(startColor, endColor, i / arr.length * 100).toString();
        },
        ease: "power2.out",
        stagger: 0.03,
        duration: 0.3
...
var xSetter = function xSetter(el) {
  return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].quickSetter(el, 'x', "px");
};
var ySetter = function ySetter(el) {
  return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].quickSetter(el, 'y', "px");
};
var xGetter = function xGetter(el) {
  return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].getProperty(el, 'x');
};
var yGetter = function yGetter(el) {
  return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].getProperty(el, 'y');
};
var pointer = {
  x: 0,
  y: 0
...
var map = {
	...
	"./ProjectBlock": [
		"./src/js/components/ProjectBlock.js",
		"ProjectBlock"
	],
	"./ProjectBlock.js": [
		"./src/js/components/ProjectBlock.js",
